...
-- Insercion de datos en la tabla Venta y DetalleVenta (Actividad Alta)
...
WHILE @i < 50000 -- 50,000 venta para actividad alta
BEGIN
    SET @ClienteID = FLOOR(RAND() * 10000) + 1; -- Asumimos 10,000 clientes
    --SET @FechaVenta = DATEADD(DAY, FLOOR(RAND() * 31), '2023-03-01'); -- Marzo (Actividad Alta)
